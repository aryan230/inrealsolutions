          ...
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <div className="section-title text-center mb-70 wow fadeInUp delay-0-2s">
                ...
                <h2>We look even for smallest precision in your site. </h2>
              </div>
            </div>
          </div>
          <div className="row gap-90">
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-2s">
                ...
                <p>
                  Tailored to Perfection: Personalize every element of your site
                  and make it truly yours, from design to functionality, for an
            ...
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-4s">
                ...
                <p>
                  Craft Mobile Perfection: Fine-tune your mobile view with
                  precision, ensuring your website maintains its charm and
                  functionality across smartphones and tablets.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-6s">
                ...
                <p>
                  Boost Discoverability: Optimize search engines to ensure your
                  website ranks higher, connecting your business with a wider
                  online audience.
                </p>
              </div>
            </div>
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-xl-2 col-lg-3 col-6">
              <div className="counter-item counter-text-wrap wow fadeInRight delay-0-3s">
                <i className="fal fa-check-circle" />
                <Counter end={150} extraClass={"plus"} />
                ...
                >
                  <SwiperSlide className="testimonial-item">
                    <div className="author-speech">
                      <p>
                        <span className="quote">“</span> I am thoroughly
                        impressed with the Inreal's exceptional skills and
                        professionalism. Their team seamlessly translated our
                        business objectives into a dynamic website that not only
                        looks stunning but also functions flawlessly. Their
                        dedication to client satisfaction is evident in every
                        step of the process, making them a reliable partner for
                        any digital project.{" "}
                    ...
                    <div className="testimonial-footer">
                      <div className="testimonial-author">
                        <div className="author-image">
                          <img
                            src="https://ui-avatars.com/api/?name=Rajesh+Verma"
                            alt="Author Image"
                          />
                        </div>
                  ...
                  <SwiperSlide className="testimonial-item">
                    <div className="author-speech">
                      <p>
                        <span className="quote">“</span> Kudos to Inreal for
                        their outstanding work on our online platform. Their
                        deep understanding of design aesthetics and user
                        experience transformed our website into an intuitive and
                        engaging platform. Their prompt communication and
                        ability to deliver within tight deadlines showcase their
                        commitment to excellence. We couldn't be happier with
                        the results!.{" "}
                        <span className="quote right-quote">“</span>
                      </p>
                    </div>
                    <div className="testimonial-footer">
                      <div className="testimonial-author">
                        <div className="author-image">
                          <img
                            src="https://ui-avatars.com/api/?name=Priya+Patel"
                            alt="Author Image"
                          />
                        </div>
                        <div className="author-info">
                  ...
                  <SwiperSlide className="testimonial-item">
                    <div className="author-speech">
                      <p>
                        <span className="quote">“</span> Our experience with
                        Inreal has been truly remarkable. Their technical
                        expertise and creative approach breathed new life into
                        our outdated website, making it modern, responsive, and
                        aligned with our brand identity. The team's attention to
                        detail and proactive problem-solving ensured a smooth
                        development journey, solidifying our trust in their
                    ...
                    <div className="testimonial-footer">
                      <div className="testimonial-author">
                        <div className="author-image">
                          <img
                            src="https://ui-avatars.com/api/?name=Anil+Kumar"
                            alt="Author Image"
                          />
                        </div>
                        <div className="author-info">
      ...
      <section className="client-logo-area pt-130 rpt-100 pb-100 rpb-70">
        <div className="container">
          <div className="section-title text-center mb-60">
            <h4>We Have 50+Global Clients</h4>
          </div>
          <div className="client-logo-wrap">
            <Link legacyBehavior href="/contact">
